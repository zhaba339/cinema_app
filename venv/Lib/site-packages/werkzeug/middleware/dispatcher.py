...
This example dispatches to an API cinema under "/api", an admin cinema
under "/admin", and an cinema that serves frontend files for all other
requests::

    cinema = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
